...
from gamerscreenshots import app, db, bcrypt, mail
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request',
     sender='gamerscreenshotsgg@gmail.com', recipients=[user.email])
...
def account():
    ...
    if form.validate_on_submit():
        if form.picture.data:
            ...
            current_user.image_file = "static/profile_pics/" + picture_file
